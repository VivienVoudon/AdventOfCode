...
{
    public class Day7_2 : Day
    {
        protected override string testInput { get; } = @"$ cd /
$ ls
dir a
14848514 b.txt
8504156 c.dat
...
7214296 k";
        ...
        protected override string input { get; } = @"$ cd /
$ ls
dir plws
dir pwlbgbz
dir pwtpltr
...
51081 vqgsglwq";
        ...
        protected override void Run(string input)
        {
                ...
                if (lineValues[0] == "$")
                {
                    ...
                    switch (lineValues[1])
                    {
                        case "cd":
                            ...
                            {
                                var newDir = new Directory(lineValues[2], currentDirectory);
            ...
            Console.WriteLine(targetDir.TotalSize());
        }
        ...
        public class Directory
        {
            ...
            {
                return Files.Sum(f => f.Size) + Childs.Sum(d => d.TotalSize());
            }
        }
